// @ts-nocheck
/**
 * Import Code Général des Impôts (CGI) from Légifrance/PISTE API
 *
 * Usage: npx tsx scripts/import-cgi.ts [--resume] [--limit N]
 *
 * Options:
...
const CGI_ID = "LEGITEXT000006069577";
const CGI_NAME = "Code général des impôts";
...
async function main() {
  ...
  console.log("     IMPORT CODE GÉNÉRAL DES IMPÔTS (CGI)");
  console.log("=".repeat(65));
  console.log("\n");
